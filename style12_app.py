...
def style12_capabilities():
    return jsonify({
        ...
        "tiers": {
            "basic": os.getenv("GEMINI_REWRITE_MODEL_BASIC", "gemini-2.5-flash-lite"),
            "premium": os.getenv("GEMINI_REWRITE_MODEL_PREMIUM", "gemini-2.5-flash"),
            "pro": os.getenv("GEMINI_REWRITE_MODEL_PRO", "gemini-2.5-pro"),
        },
